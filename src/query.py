...
def query():
    ...
    q = "First tell me the importance of each metrics and the meaning of the score. "
    q = "Then, for each of the ten companies, use the provided data, summarize why each of them are a good target to buy. "
